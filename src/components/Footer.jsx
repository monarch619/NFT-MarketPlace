...
export default function Footer() {
  ...
  const contactInfo = [
    {
      icon: <MdEmail />,
      value: "sahulkumarparida@gmail.com",
    },
    {
      icon: <MdPhoneInTalk />,
      value: "+(91) 7439730856",
    },
    {
      ...
      value: "32/7, Sarat Chandra Road, Kolkata-700008",
    },
  ];
  const socialIcons = [
    <AiFillFacebook />,
  ...
  return (
    <Container>
      <div className="row">
        ...
        <p className="description">NH-95, Ludhiana - Chandigarh State Highway, Punjab 140413</p>
